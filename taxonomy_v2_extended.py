"""
iFA 지식체계 마스터 데이터 v2.1 (도메인 지식 기반 확장)

도메인 문서 (domain_knowledge.md) 기반 추가 항목:
- GA 유형, 조직 구조 추가
- 법률/규정 문서유형 추가
- 설계사 자격증/등급 추가
- 규제 일정 관리
...
# ═══════════════════════════════════════════════════════════════════════════════
# FACET 2: 상품군 (Product Line) - 2단계 계층
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# FACET 3: 문서유형 (Document Type) - 도메인 지식 기반 확장
# ═══════════════════════════════════════════════════════════════════════════════
...
GA_TYPES = {
    "GA-BRANCH": {
        "name": "지사형",
        "description": "연합, 독립채산제",
        "examples": ["GA코리아", "글로벌금융판매"],
        "control_rating": "low"  # 내부통제 평가 낮음
    },
    "GA-OWNER": {
        "name": "독립형/오너형",
        "description": "본점 중심 운영",
        "examples": ["인카금융서비스", "피플라이프"],
        "control_rating": "high"
    },
    "GA-SUBSIDIARY": {
        "name": "자회사형",
        "description": "보험사 설립 GA",
        "examples": ["한화생명금융서비스", "삼성화재금융서비스"],
        "control_rating": "mid",
        "risk": "모회사 상품 쏠림"
    },
    "GA-HOMESHOPPING": {
        "name": "홈쇼핑형",
        "description": "콜센터 아웃소싱",
        "control_rating": "mid"
    },
    "GA-DIGITAL": {
        "name": "디지털GA",
...
REGULATION_TIMELINE = [
    {
        "date": "2024-01-01",
        "name": "대형GA 내부통제 실태평가",
        "description": "500인 이상 GA 평가 시행",
        "status": "active"
    },
    {
        "date": "2026-01-01",
        "name": "차익거래 금지기간 확대",
        "description": "전기간 확대, 수수료율 비교공시",
        "status": "upcoming"
    },
    {
        "date": "2026-07-01",
        "name": "1200%룰 GA 확대",
        "description": "GA 소속 설계사에게도 적용",
        "status": "upcoming",
        "impact": "high"
    },
    {
        "date": "2027-01-01",
        "name": "4년 분급제 시행",
        "description": "선지급 수수료 제한, 유지관리수수료 신설",
        "status": "upcoming",
        "impact": "high"
    },
    {
...
def export_to_json(filepath: str = "taxonomy_v2.1.json"):
    """JSON으로 내보내기"""
    data = {
        "version": "2.1",
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("iFA KMS Taxonomy v2.1 Statistics")
    print("=" * 60)
